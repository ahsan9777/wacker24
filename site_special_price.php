						...
						<div class="category_type_product">
							<div class="category_type_inner full_column">
								<div class="category-slider">
									...
									$Query = "SELECT usp.level_one_id, MIN(usp.level_two_id) AS level_two_id, MIN(usp.supplier_id) AS supplier_id, c.cat_title_de AS cat_title, c.cat_params_de AS cat_params FROM user_special_price AS usp LEFT JOIN category AS c ON c.group_id = usp.level_one_id AND c.parent_id = '0' WHERE usp.user_id = '0' AND usp.level_two_id > 0 AND usp.supplier_id > 0 GROUP BY usp.level_one_id, c.cat_title_de, c.cat_params_de ORDER BY usp.level_one_id ASC;";
									//print($Query);die();

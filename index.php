													...
													<div class="pd_ctg_card">
														<a href="product_detail.php?supplier_id=<?php print($row2->supplier_id); ?>">
															...
															<div class="pd_ctg_title pbp_price_with_tex" <?php print($pbp_price_with_tex_display); ?>>
																<del><?php print(str_replace(".", ",", $row2->pbp_price_amount)); ?>€</del> | <span class="pd_ctg_discount_price"><?php print(discounted_price($special_price['usp_price_type'], $row2->pbp_price_amount, $special_price['usp_discounted_value'], 1)); ?>€</span>
															</div>
														</a>
													</div>
											<?php

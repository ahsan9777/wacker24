						...
						<div class="gerenric_product_category">
							...
							<div class="pd_ctg_block">
								...
								<div class="pd_ctg_row">
									...
									$Query2 = "SELECT * FROM ( SELECT MIN(cm.cat_id) AS cat_id, MIN(cm.supplier_id) AS supplier_id, c.group_id, MAX(c.cat_title_de) AS cat_title, MIN(pg.pg_mime_source_url) AS pg_mime_source, RAND() AS rand_col FROM category_map AS cm LEFT OUTER JOIN category AS c ON c.group_id = SUBSTRING(cm.cat_id, 1, 3) LEFT OUTER JOIN products_gallery AS pg ON pg.supplier_id = cm.supplier_id AND pg.pg_mime_purpose = 'normal' AND pg.pg_mime_order = '1' WHERE FIND_IN_SET(".$row1->group_id.", cm.sub_group_ids) GROUP BY c.group_id) AS subquery ORDER BY rand_col LIMIT 0,4";
									...
									<div class="pd_ctg_card">
										<a href="products.php?level_three=<?php print($row2->cat_id); ?>">
											<div class="pd_ctg_image"><img src="<?php print($row2->pg_mime_source); ?>" alt=""></div>
						...
						<div class="gerenric_white_box">
							<div class="gerenric_product full_column">
								...
								<?php 
									...
									<div>
										<div class="pd_card">
											<div class="pd_image"><a href="product_detail.php?supplier_id=<?php print($row2->supplier_id); ?>"><img src="<?php print($row2->pg_mime_source_url); ?>" alt=""></a></div>
											<div class="pd_detail">
							...
							<div class="brand_slider">
								...
								<div>
									<div class="brand_col"><a href="javascript:void(0)">
											<div class="brand_item"><img src="<?php print($brand_image_href) ?>" alt="<?php print($row->brand_name) ?>" title="<?php print($row->brand_name) ?>">
											</div>
										</a></div>
								</div>
								<?php } ?>

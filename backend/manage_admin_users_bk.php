            ...
            <section class="content" id="main-content">
                        ...
                        <form name="frm" id="frm" method="post" action="<?php print($_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING']); ?>" role="form" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6 col-12 mt-3">
                                    ...
                                    <select name="utype_id" class="input_style" id="utype_id">
                                        <?php FillSelected2("user_type", "utype_id", "utype_name ", $countries_id, "utype_id IN (1,2)"); ?>
                                    </select>
                                </div>
                                <div class="col-md-6 col-12 mt-3">
                                    <label for="">Company</label>
                                    <input type="text" required class="input_style" name="user_company_name" id="user_company_name" value="<?php print($user_company_name); ?>" placeholder="Company">
                                </div>
                                <div class="col-md-6 col-12 mt-3">
                ...
                <?php } else { ?>
                    <div class="table-controls">
                        <h1 class="text-white">Admin Users Management</h1>

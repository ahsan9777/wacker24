...
<aside class="sidebar">
    ...
    <nav>
        <ul class="accordion-menu">
            ...
            <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link accordion <?php echo ( $pg == 'manage_products' || $pg == 'manage_sales_system' || $pg == 'manage_custom_products' || $pg == 'manage_products_bundle_price' || $pg == 'manage_products_feature' || $pg == 'manage_products_keyword' || $pg == 'manage_products_quantity' || $pg == 'manage_products_gallery') ? $cu : ''; ?>"><span class="material-icons icon">add</span> <span class="text">Artikel</span></a>
                <ul class="sub-menu panel" <?php echo ( $pg == 'manage_products' || $pg == 'manage_sales_system' || $pg == 'manage_custom_products' || $pg == 'manage_products_bundle_price' || $pg == 'manage_products_feature' || $pg == 'manage_products_keyword' || $pg == 'manage_products_quantity' || $pg == 'manage_products_gallery') ? $c : ''; ?>>

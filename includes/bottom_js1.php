...
<link rel="preload" href="https://cdn.jsdelivr.net/npm/font-awesome@4.3.0/css/font-awesome.min.css" as="style" onload="this.rel='stylesheet'">
<noscript><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/font-awesome@4.3.0/css/font-awesome.min.css"></noscript>
<script defer>
    setTimeout(function() {
        const scripts = [
            "js/jquery-ui.min.js"
...
<style>
    .ui-widget.ui-widget-content{z-index: 9999999; padding: 20px 10px; font-size: 18px; }
</style>
<script defer>
    function blinker() {
...
<script src="./backend/assets/js/jquery-ui-1.10.3.custom.min.js" defer></script>

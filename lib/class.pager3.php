...
class Pager1 {
     ...
     ***********************************************************************************/
    function pageList($curpage, $page_ref, $pages, $qryString) {
        $page_list  = "";

        /* Print the first and previous page links if necessary */
        if (($curpage != 1) && ($curpage)) {
            $page_list .= " <li><a href=\"".$page_ref."/1".$qryString."\" title=\"First Page\" class=\"numbr selected\"><<</a></li>";
        }
        ...
        if (($curpage-1) > 0) {
            ...
            $page_list .= "<li><a href=\"".$page_ref."/".($curpage-1).$qryString."\" title=\" Vorherige Seite ".($curpage-1)."\">". "<i class=\"fa fa-caret-left\"></i> Letzte"."</a></li>";
        ...
        for ($i= $startShow; $i<= $showPages; $i++){
            if($i <= $pages){
                if ($i == $curpage) {
                    ...
                    $page_list .= "<li><a href=\"" . $page_ref . "/" . $i . $qryString . "\" title=\"Seite " . $i . "\">" . $i . "</a></li>";
                }
                $page_list .= " ";
            }
        }
        ...
        if (($curpage+1) <= $pages) {
            ...
            $page_list .= "<li class=\"arrowright\"><a href=\"".$page_ref."/".($curpage+1).$qryString."\" title=\" Nächste Seite ".$i."\">"."Nächste <i class=\"fa fa-caret-right\"></i>"."</a></li>";
        ...
        if (($curpage != $pages) && ($pages != 0)) {
            ...
            $page_list .= "<li><a href=\"".$page_ref."/".$pages.$qryString. "\" title=\"Letzte Seite\">>></a></li>";
        }
        //$page_list .= "</td>\n";

        return $page_list;
    }
    function pageList1($curpage, $pages, $qryString) {
        $page_list  = "";

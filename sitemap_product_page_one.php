...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    ...
    <?php
    $rsp = mysqli_query($GLOBALS['conn'], "SELECT pro_cdate, pro_udate, supplier_id, pro_ean, pro_udx_seo_epag_title_params_de FROM products WHERE pro_status='1' LIMIT 0,8000");

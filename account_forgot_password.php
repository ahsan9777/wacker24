		...
		<section id="content_section">
			<div class="appointment_booking gerenric_padding">
				<div class="page_width">
					<h2 class="txt_align_center">Anfrage für Konto-Passwort vergessen</h2>

					<div class="txt_align_center">
						<div class="alert alert-success">Ihre Anfrage zum Vergessen des Passworts wurde angenommen.<br> Bitte überprüfen Sie Ihre E-Mails<br></div>
